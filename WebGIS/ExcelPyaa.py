...
worksheet.cell(1, 1).value = '行政区   代码'
worksheet.cell(1, 1).alignment = alignment
worksheet.cell(1, 2).value = '行政区   名称'
worksheet.cell(1, 2).alignment = alignment
worksheet.cell(1, 3).value = '合计'
worksheet.cell(1, 3).alignment = alignment
worksheet.cell(1, 4).value = '宜耕小计'
worksheet.cell(1, 4).alignment = alignment
worksheet.cell(1, 5).value = '宜耕\n其他草地'
worksheet.cell(1, 5).alignment = alignment
worksheet.cell(1, 6).value = '宜耕\n盐碱地'
worksheet.cell(1, 6).alignment = alignment
worksheet.cell(1, 7).value = '宜耕\n沙地'
worksheet.cell(1, 7).alignment = alignment
worksheet.cell(1, 8).value = '宜耕\n裸地'
worksheet.cell(1, 8).alignment = alignment
worksheet.cell(1, 9).value = '不宜耕小计'
worksheet.cell(1, 9).alignment = alignment
worksheet.cell(1, 10).value = '不宜耕\n其他草地'
worksheet.cell(1, 10).alignment = alignment
worksheet.cell(1, 11).value = '不宜耕\n盐碱地'
worksheet.cell(1, 11).alignment = alignment
worksheet.cell(1, 12).value = '不宜耕\n沙地'
worksheet.cell(1, 12).alignment = alignment
worksheet.cell(1, 13).value = '不宜耕\n裸地'
worksheet.cell(1, 13).alignment = alignment
worksheet.cell(1, 14).value = '其他'
worksheet.cell(1, 14).alignment = alignment
...
for i in range(len(xzqdm_list)) :
    ...
    if xzqdm_list[i] != xzqdm :
        ...
        xzqdm = xzqdm_list[i]
        row = row + 1
    if (zldwdm_list[i] != zldwdm) or (zldwmc_list[i] != zldwmc):
        ...
        worksheet.cell(row+index,9).value = worksheet.cell(row+index,10).value +worksheet.cell(row+index,11).value+worksheet.cell(row+index,12).value+worksheet.cell(row+index,13).value+worksheet.cell(row+index,14).value
        worksheet.cell(row+index,3).value = worksheet.cell(row+index,4).value+worksheet.cell(row+index,9).value
        zldwdm = zldwdm_list[i]
        zldwmc = zldwmc_list[i]
    else :
        row = row -1
        if dlmc_list[i] == '其他' :
